...
import "./style.scss";
import { TICTACTOEEXP_URL } from "../../utilities/URL";

// TO DO: change to env variable
// const ENDPOINT = process.env.REACT_APP_SOCKET_SERVER_URL;

class TicTacToeExpanded extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      currentSocket: null,
...
function connectSocket(cb) {
  ...
  const serverUrl = TICTACTOEEXP_URL;
...
export default TicTacToeExpanded;
